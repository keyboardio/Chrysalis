    ...
    >
      <g transform="matrix(1,0,0,1,-70,-55)">
        ...
        <Key
          ...
          shape="M791.753 307.24L751.01 288.5c-1.89-.868-2.22-1.115-2.248-3.769l-.467-46.066c-.026-2.654.361-3.367 3.017-3.371l42.26-.065c2.655-.004 2.76.09 2.693 2.744l-1.647 66.54c-.086 3.486-.678 3.487-2.865 2.727z"
        />
        <Key
          {...keyProps}
          row="3"
        ...
        <Key
          ...
          shape="M460.083 340.12c13.836 6.396 26.241 13.35 38.202 20.933 1.47.934 2.602 2.766.996 5.186l-28.128 42.455c-1.604 2.422-3.249 1.757-4.687.8-9.563-6.364-19.696-11.544-30.37-16.619-1.438-.682-3.245-1.781-2.065-4.436l20.952-47.147C454.983 341.292 456.163 339.457 460.083 340.12z"
        />
        <Key
          {...keyProps}
          row="3"
        ...
        <Key
          ...
          shape="M733.865 307.748c-15.175-1.416-29.81-1.592-43.963-1.039-1.739.07-3.766.892-3.591 3.79l3.063 50.339c.174 2.899 1.85 3.857 3.573 3.75 11.465-.703 23.113-.164 34.891.808 1.586.131 3.449-.052 3.76-2.94l5.55-51.292c.312-2.888-1.71-3.27-3.2829-3.416z"
        />
        <Key
          {...keyProps}
          row="0"
          ...
          shape="M279.981 307.748c15.175-1.416 29.81-1.592 43.963-1.039 1.739.07 3.766.892 3.591 3.79l-3.063 50.339c-.174 2.899-1.85 3.857-3.573 3.75-11.465-.703-23.113-.164-34.891.808-1.586.131-3.449-.052-3.76-2.94l-5.55-51.292c-.312-2.888 1.71-3.27 3.2829-3.416z"
        />
        <Key
          {...keyProps}
          row="0"
