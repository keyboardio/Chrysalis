...
export default function Key({ x, y, selected, clicked, centered, content }) {
  return (
    <g className="keycap">
      {content.type === "enter" ? (
        <>
