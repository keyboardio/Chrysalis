...
const oneshot = [
  osm(0, { full: "Left Control", "1u": "LCtrl" }),
  osm(1, { full: "Left Shift", "1u": "LSft" }),
  osm(2, "Alt"),
  osm(3, { full: "Left " + GuiLabel.full, "1u": "L" + GuiLabel["1u"] }),
  osm(4, { full: "Right Control", "1u": "RCtrl" }),
  osm(5, { full: "Right Shift", "1u": "RSft" }),
  osm(6, "AltGr"),
  osm(7, { full: "Right " + GuiLabel.full, "1u": "R" + GuiLabel["1u"] }),
  osl(0),
  osl(1),
  osl(2),
  osl(3),
