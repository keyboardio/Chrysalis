...
const japaneseCATable = withModifiers(
    table,
    "Control + Alt +",
    "C+A+",
    768
...
const japaneseCSTable = withModifiers(
    table,
    "Control + Shift +",
    "C+S+",
    2304
...
const japaneseCGTable = withModifiers(
    table,
    "Control + Gui +",
    "C+G+",
    4352
...
const japaneseAAGrTable = withModifiers(
    table,
    "Alt + AltGr +",
    "A+AGr+",
    1536
...
const japaneseAGrGTable = withModifiers(
    table,
    "AltGr + Gui +",
    "AGr+G+",
    5120
